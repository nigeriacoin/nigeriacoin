...
python-nigeriacoinrpc: git subtree of https://github.com/jgarzik/python-nigeriacoinrpc
Changes to python-nigeriacoinrpc should be made upstream, and then

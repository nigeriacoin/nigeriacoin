...
NIGERIACOIND=${1}/nigeriacoind
CLI=${1}/nigeriacoin-cli
...
B4ARGS="-datadir=$D4"
$NIGERIACOIND $NIGERIACOINDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$NIGERIACOIND $NIGERIACOINDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $NIGERIACOIND $NIGERIACOINDARGS $B1ARGS &
  B1PID=$!
  $NIGERIACOIND $NIGERIACOINDARGS $B2ARGS &
  B2PID=$!
  $NIGERIACOIND $NIGERIACOINDARGS $B3ARGS &
  B3PID=$!
}

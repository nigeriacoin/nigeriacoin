The following is a list of assets used in the nigeriacoin source and their proper attribution.
...
* License: MIT
* Site: [https://nigeriacointalk.org/index.php?topic=15276.0](https://nigeriacointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original nigeriacoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/nigeriacoin.icns, src/qt/res/src/nigeriacoin.svg,
	src/qt/res/src/nigeriacoin.ico, src/qt/res/src/nigeriacoin.png,
	src/qt/res/src/nigeriacoin_testnet.png, docs/nigeriacoin_logo_doxygen.png,

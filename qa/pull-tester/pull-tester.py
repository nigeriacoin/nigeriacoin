...
environ_default("CLONE_URL", "https://github.com/nigeriacoin/nigeriacoin.git")
...
environ_default("BUILD_PATH", "/mnt/nigeriacoin")
...
environ_default("GITHUB_REPO", "nigeriacoin/nigeriacoin")
